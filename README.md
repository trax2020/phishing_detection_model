...
| **compact\_feature\_extractor.py**   | Extracts **Scalable Color Descriptor (SCD) and Colour Layout Descriptor (CLD)** and potentially other compact visual features from website screenshots.                                                    |
...
| **phishing\_detector.py**            | The main detection pipeline script. Combines all components: captures screenshot, extracts features, applies classifiers, fuses outputs, returns final decision. |
