...
if __name__ == "__main__":
    ...
    true_labels_dict = {'CNN': cnn_labels, 'RandomForest': rf_labels}
    preds_dict = {'CNN': cnn_preds, 'RandomForest': rf_preds}
    evaluator.plot_combined_roc(true_labels_dict, preds_dict)

    # Report
    print(evaluator.generate_report("evaluation_report.txt"))
